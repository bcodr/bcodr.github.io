...
if(jQuery('body').hasClass('fl-builder-edit')&&this.small_device<30){jQuery('body').find(node).addClass('uabb-mobile-spacer-height-adjustment');}},};})(jQuery);jQuery(document).ready(function(){new UABBSpacerGap({id:'5acc0e7b40b6b',desktop_space:'200',medium_device:'',small_device:'',});});(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5abce2028ffa0 .pp-heading-separator, .fl-node-5abce2028ffa0 .pp-heading').removeClass('pp-center');$('.fl-node-5abce2028ffa0 .pp-heading-separator, .fl-node-5abce2028ffa0 .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-5abce2028ffa0 .pp-heading-separator, .fl-node-5abce2028ffa0 .pp-heading').removeClass('pp-center');$('.fl-node-5abce2028ffa0 .pp-heading-separator, .fl-node-5abce2028ffa0 .pp-heading').addClass('pp-mobile-center');}})(jQuery);jQuery(document).ready(function(){new UABBSpacerGap({id:'5acc0e81b935f',desktop_space:'200',medium_device:'',small_device:'',});});(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5abce85804baa .pp-heading-separator, .fl-node-5abce85804baa .pp-heading').removeClass('pp-center');$('.fl-node-5abce85804baa .pp-heading-separator, .fl-node-5abce85804baa .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-5abce85804baa .pp-heading-separator, .fl-node-5abce85804baa .pp-heading').removeClass('pp-center');$('.fl-node-5abce85804baa .pp-heading-separator, .fl-node-5abce85804baa .pp-heading').addClass('pp-mobile-center');}})(jQuery);(function($){PPFilterableGallery=function(settings)
...
{var node=$(this.nodeClass);var wrap=$(this.wrapperClass);var items=$(this.itemClass);var filterData=this.filterData;var filters=wrap.isotope(filterData);var filtersWrap=node.find('.pp-gallery-filters');var filterToggle=node.find('.pp-gallery-filters-toggle');var isMasonry=this.masonry;wrap.imagesLoaded($.proxy(function(){if(wrap.find('.pp-gallery-overlay').length>0){var imgW=wrap.find('.pp-gallery-img').outerWidth();wrap.find('.pp-gallery-overlay').css('max-width',imgW+'px');}
filterToggle.on('click',function(){filtersWrap.slideToggle(function(){if($(this).is(':visible')){$(this).addClass('pp-gallery-filters-open');}
if(!$(this).is(':visible')){$(this).removeClass('pp-gallery-filters-open');}});});filtersWrap.on('click','.pp-gallery-filter-label',function(){var filterVal=$(this).attr('data-filter');filters.isotope({filter:filterVal});filtersWrap.find('.pp-gallery-filter-label').removeClass('pp-filter-active');$(this).addClass('pp-filter-active');filterToggle.find('span.toggle-text').html($(this).text());if(filtersWrap.hasClass('pp-gallery-filters-open')){filtersWrap.slideUp();}});setTimeout(function(){node.find('.pp-filter-active').trigger('click');if(isMasonry){wrap.isotope('layout');}
items.css('visibility','visible');},1000);},this));},};})(jQuery);;(function($){$(window).on('load',function(){var gallery_selector=$('.fl-node-5acc3bb9793cc .pp-photo-gallery');if(gallery_selector.length&&typeof $.fn.magnificPopup!=='undefined'){gallery_selector.magnificPopup({delegate:'.pp-gallery-item:visible .pp-photo-gallery-content a',closeBtnInside:true,type:'image',gallery:{enabled:true,navigateByImgClick:true,},'image':{titleSrc:function(item){}},mainClass:'mfp-5acc3bb9793cc'});}});var options={id:'5acc3bb9793cc',layout:'masonry',captions:'0',};$(window).on('load',function(){new PPFilterableGallery(options);});var state=0;$(document).on('pp_expandable_row_toggle',function(e,selector){if(selector.is('.pp-er-open')&&state===0&&selector.find('.fl-node-5acc3bb9793cc').length>0){new PPFilterableGallery(options);state=1;}});var accordion_state=false;$(document).on('pp-accordion-toggle-complete',function(e,selector){if(!accordion_state){new PPFilterableGallery(options);accordion_state=true;}});var tabs_state=false;$(document).on('pp-tabs-switched',function(e,selector){if(selector.find('.pp-photo-gallery-content').length>0&&!tabs_state){new PPFilterableGallery(options);tabs_state=true;}});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5abce8653c790 .pp-heading-separator, .fl-node-5abce8653c790 .pp-heading').removeClass('pp-center');$('.fl-node-5abce8653c790 .pp-heading-separator, .fl-node-5abce8653c790 .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-5abce8653c790 .pp-heading-separator, .fl-node-5abce8653c790 .pp-heading').removeClass('pp-center');$('.fl-node-5abce8653c790 .pp-heading-separator, .fl-node-5abce8653c790 .pp-heading').addClass('pp-mobile-center');}})(jQuery);