...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-5abcddf3c5b06 .pp-heading-separator, .fl-node-5abcddf3c5b06 .pp-heading').removeClass('pp-center');$('.fl-node-5abcddf3c5b06 .pp-heading-separator, .fl-node-5abcddf3c5b06 .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-5abcddf3c5b06 .pp-heading-separator, .fl-node-5abcddf3c5b06 .pp-heading').removeClass('pp-center');$('.fl-node-5abcddf3c5b06 .pp-heading-separator, .fl-node-5abcddf3c5b06 .pp-heading').addClass('pp-mobile-center');}})(jQuery);(function($){$(function(){if(typeof $.fn.magnificPopup!=='undefined'){$('.fl-node-5b083c6297a02 .fl-mosaicflow-content, .fl-node-5b083c6297a02 .fl-gallery').magnificPopup({delegate:'.fl-photo-content > a',closeBtnInside:false,type:'image',gallery:{enabled:true,navigateByImgClick:true,},'image':{titleSrc:function(item){}},callbacks:{open:function(){if(this.items.length>0){var parent,item,newIndex=0,newItems=[];$(this.items).each(function(i,data){item=$(this);if('undefined'!==typeof this.el){item=this.el;}
...
$('.fl-node-5b083c6297a02 .fl-mosaicflow-content').one('mosaicflow-filled',function(){var hash=window.location.hash.replace('#','');if(hash!=''){FLBuilderLayout._scrollToElement($('#'+hash));}
